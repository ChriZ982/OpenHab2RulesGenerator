...
public:
    ...
    static std::vector<std::string> group_by_condition(const std::vector<std::string> &lines);
    static std::vector<std::string> group_by_if_condition(const std::vector<std::string> &lines);
};
}
